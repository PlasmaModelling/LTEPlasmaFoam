...
const Foam::Enum
<
    Foam::magneticCoupledBase::SMethodType
>
Foam::magneticCoupledBase::SMethodTypeNames_
{
...
Foam::magneticCoupledBase::magneticCoupledBase
(
    const fvPatch& patch,
...
Foam::tmp<Foam::scalarField> Foam::magneticCoupledBase::sigmaE
(
    const vectorField& Tp
) const
{
...
void Foam::magneticCoupledBase::write(Ostream& os) const
{
