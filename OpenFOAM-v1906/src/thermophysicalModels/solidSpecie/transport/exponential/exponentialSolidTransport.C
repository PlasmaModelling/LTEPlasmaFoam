...
:
    ...
    sigmaE0_(dict.subDict("transport").get<scalar>("sigmaE0")),
    n0s_(dict.subDict("transport").get<scalar>("n0s")),
    Trefs_(dict.subDict("transport").get<scalar>("Trefs"))
{}
...
) const
{
    ...
    // Entries in dictionary format
    {
        ...
        os.writeEntry("sigmaE0", sigmaE0_);
        os.writeEntry("n0s", n0s_);
        os.writeEntry("Trefs", Trefs_);
        os.endBlock();
    }
}
