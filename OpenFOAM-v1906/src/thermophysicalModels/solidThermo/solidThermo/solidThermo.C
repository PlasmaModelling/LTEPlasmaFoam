...
Foam::tmp<Foam::volScalarField> Foam::solidThermo::sigmaE() const
{
    return sigmaE_;
}


Foam::tmp<Foam::scalarField> Foam::solidThermo::sigmaE(const label patchi) const
{
    return sigmaE_.boundaryField()[patchi];
}


Foam::volScalarField& Foam::solidThermo::sigmaE()
{
    return sigmaE_;
}
